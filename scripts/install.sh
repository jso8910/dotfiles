...
install_pkg powercord-git discord discord-canary powercord-git nodejs-lts-dubnium nvm
...
install_pkg bottom tldr light i3-volume mako swaybg mopidy ncmpcpp swayidle swaylock-effects-git grimshot xorg-xwayland thefuck sunwait wallutils wl-clipboard libnotify exa nodejs bibata-extra-cursor-theme nwg-wrapper
