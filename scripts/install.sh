...
install_pkg bottom-bin tldr light i3-volume mako swaybg mopidy ncmpcpp swayidle swaylock grimshot xorg-xwayland thefuck sunwait wallutils wl-clipboard libnotify
